...
SELECT nomEmploye, idEmploye FROM Employe, Ouvrage WHERE idEmploye IN (SELECT idEmploye FROM Emprunt WHERE dateFin = NULL); #Permet de trouver les employés qui n'ont pas rendus leurs livres
